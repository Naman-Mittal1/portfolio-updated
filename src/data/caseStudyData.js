const caseStudyData = [
    {
      ...
      description: 'Agrisar connects farmers, warehouses, and consumers on one platform to improve transparency, collaboration...',
      tags: ['Supply Chain Management', 'Agriculture', 'Machine Learning', 'Web Development'],
      ...
      featuresPointHeading5: 'Multiple Languages Support',
      featuresPoint1: 'Farmers can list crops and connect with buyers directly without middlemen.',
      featuresPoint2: 'Analyze sales patterns, demand forecasting, pricing analytics to inform decisions.',
      featuresPoint3: 'Warehouse owners can list storage facilities to provide farmers more inventory management options.',
      featuresPoint4: 'Farmers can monitor crop health and production levels for each harvest.',
      featuresPoint5: 'It improves accessibility and ensures the technology can reach and benefit all farmers.',
      ...
      benifitsPoint1: 'By digitizing and automating processes, Agrisar reduces manual paperwork and saves time for farmers.',
      benifitsPoint2: 'Tracking expenses, inventory, and crops gives farmers greater visibility across operations.',
      benifitsPoint3: 'Predictive analytics helps farmers optimize crop yields and make data-driven decisions.',
      benifitsPoint4: 'Farmers can reach more buyers directly through the integrated marketplace.',
      benifitsPoint5: 'Removing middlemen and optimizing logistics reduces operational costs for farmers.',
