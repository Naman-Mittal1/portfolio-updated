const caseStudyData = [
  {
    ...
    benifitsStyle: '{"display": "flex"}',
    benifitsHeading: 'Benefits',
  ...
  {
    id: 2,
    title: "Responsive Website Design for Metablock Technologies",
    description: "As the lead front-end developer, I successfully designed and implemented a responsive corporate website for Metablock Technologies..",
    ...
    imageUrl: "/images/metablock.png",


    
    overviewPara1: "Metablock Technologies, a startup offering blockchain consulting and development services, required a new corporate website to establish their brand and attract potential clients. As the lead front-end developer, I was responsible for implementing the responsive website design provided by the design team. The key requirements were to accurately translate the visual mockups into pixel-perfect web pages, while ensuring optimal user experience across devices. This involved leveraging modern web technologies including HTML5, CSS3, JavaScript ES6, jQuery and Git version control to build an accessible, high-performance, and SEO-friendly website aligned with Metablock's brand identity.",
    
    overviewPara2: "Throughout the agile development process, I collaborated closely with stakeholders to iterate on the layouts, components, and features. Extensive testing was done to guarantee cross-browser compatibility, responsiveness on mobile devices, compliance with web standards, and accurate representation of the brand styleguide. The end result exceeded expectations in effectively communicating Metablock's capabilities and expertise through a visually stunning and interactive website.",

    process: "The projectfollowed an agile methodology with 2-week sprints. Requirements were gathered through meetings with stakeholders. Design mockups were provided by the design team. I implemented the frontend using HTML, CSS, Javascript, and jQuery, meeting accessibility and performance standards. Version control was maintained in Git. Extensive testing ensured cross-browser compatibility.",
    ...
    featuresPointHeading1: 'UI UX Management',
    featuresPointHeading2: 'Generating Leads',
    featuresPointHeading3: 'Worked as a Team',
    featuresPointHeading4: 'Finished on time',
    featuresPointHeading5: 'Internship Experience',

    featuresPoint1: 'Conveyed expertise and built trust through content, visuals and UX',
    featuresPoint2: 'Generated leads through clear calls-to-action and contact forms',
    featuresPoint3: 'Ensured great user experience across devices with responsive design',
    featuresPoint4: 'Delivered site on-time and within budget through agile process',
    featuresPoint5: 'Got experience to work as a team During the 6 month internship',

    featuresHeading: 'Key Outcomes',


    benifitsStyle: '{"display": "none"}',
    benifitsHeading: '',

    techStack: "HTML5, CSS, Javascript, JQuery, git",
